...
; Author: Grimdoomer
;
; The RF xbe has the following timestamps:
;
; Image timestamp                     : 0x3D94CEEE Fri Sep 27 14:34:38 2002
; PE timestamp                        : 0x3D94CEE0 Fri Sep 27 14:34:24 2002
; Certificate timestamp               : 0x3D9C0996 Thu Oct 03 02:10:46 2002
...
; Constants
%define VtableThingAddress      1B22D8h     ; Address of the vtable thing we overwrite with our shellcode
%define ParkFileHeaderAddress   27EC10h     ; Address of where the first 136 bytes of the park file get put on to the data segment
